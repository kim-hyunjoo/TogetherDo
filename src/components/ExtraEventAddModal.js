...
const ExtraEventAddModal = (props) => {
// 열기, 닫기, 모달 헤더 텍스트를 부모로부터 받아옴
const { open, close, header, changeColor, isBluePicked, isGrBluePicked, isGreenPicked, isGreyPicked, 
    isOrangePicked, isPinkPicked, isPurplePicked, isYellowPicked, startTimeRef, endTimeRef, defaultData, 
    editMode, noTimeDisable, noTimeClicked, eventRef, onSaveEvent, disable } = props;
...
export default ExtraEventAddModal;